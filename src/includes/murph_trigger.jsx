...
const LeftIcon = () => (
	<svg viewBox="0 0 16 16" className="bi bi-text-indent-left" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
		<path fillRule="evenodd" d="M2 3.5a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5zm.646 2.146a.5.5 0 0 1 .708 0l2 2a.5.5 0 0 1 0 .708l-2 2a.5.5 0 0 1-.708-.708L4.293 8 2.646 6.354a.5.5 0 0 1 0-.708zM7 6.5a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5zm0 3a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5zm-5 3a.5.5 0 0 1 .5-.5h11a.5.5 0 0 1 0 1h-11a.5.5 0 0 1-.5-.5z"/>
	</svg>
);
...
const MurphTrigger = ({ show, type, onTrigger, children }) => {
	return (
		<div className="icon" style={{ ...TRIGGER_STYLE, opacity: (show ? 0.5 : 1) }} onClick={ onTrigger } >
	        { show ? (
	            type === 'left' ? <LeftIcon /> : <DownIcon />
	        ) : (
	            type === 'right' ? <LeftIcon /> : <RightIcon />
	        ) }
        </div>
	);
};

export default MurphTrigger;